      ...
      <div className="relative">
        ...
        >
          <div
            ...
            className={clsx(
              "flex items-center p-3 pl-4 text-secondary-400 hover:bg-primary-200 flex-1 transition-all text-md cursor-pointer select-none",
              isCurrentRoute && "text-secondary-700 font-semibold",
              className
            )}
          >
